...
async function main() {
  console.log("🔷 Deploying LUMIN Smart Contracts to Polygon Network...")
  ...
  // Display deployment summary for Polygon
  console.log("\n🎉 LUMIN Polygon Network Deployment Complete!")
  ...
  console.log("\n🔷 LUMIN is ready on Polygon Network!")
